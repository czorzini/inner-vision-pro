        ...
        <>
            <div className='max-w-7xl mx-auto w-full p-4 mt-10'>
                <div className="max-w-4xl mx-auto text-5xl my-24 flex flex-col gap-6">
                    ...
                    <div className="max-w-3xl font-bold text-6xl md:text-7xl lg:text-[100px] lg:leading-[100px]">Play it<br /><span className="text-alpha">by ear.</span></div>
                    ...
                    <div className="grid md:grid-cols-2 gap-6 divide-x-[1px] divide-white/20">
                        <div className="flex flex-col justify-between gap-2 px-10 py-16">
                            <div className="flex flex-col w-full items-center gap-1">
                                ...
                                <div className="w-full font-bold text-6xl md:text-7xl lg:text-[100px] lg:leading-[100px] flex justify-center items-end gap-2"><span className="text-alpha">800 </span> <span className="text-5xl md:text-7xl"> recordings</span></div>
                            ...
                            <div className="flex flex-col w-full items-center gap-1">
                                ...
                                <div className="w-full font-bold text-6xl md:text-7xl lg:text-[100px] lg:leading-[100px] flex justify-center items-end gap-2"><span className="text-alpha">0 </span> <span className="text-5xl md:text-7xl"> profit</span></div>
