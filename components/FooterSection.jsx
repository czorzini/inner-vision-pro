        ...
        <>
            <div className="w-full bg-[#FFF2F0] text-black">
                <div className='max-w-5xl mx-auto w-full px-4 py-12 md:py-20 flex flex-col md:flex-row md:justify-between md:items-center gap-6'>
                    ...
                    <div><Link href={`https://earth.fm`} target="_blank" className="bg-beta flex-shrink-0 text-white px-8 py-3 rounded-lg hover:bg-beta/80 transition-all duration-300">Join the family</Link></div>
                </div>
            </div>
            <div className="w-full bg-[#FFF2F0] text-black border-t border-beta/50 font-normal font-sans">
                <div className='max-w-7xl mx-auto w-full px-4 pt-12 pb-20 md:pb-24 grid sm:grid-col-8 lg:grid-cols-4 gap-2 sm:gap-3'>
